...
```{r} #NEXT STEP FIT THIS SIM TO RA instead of WSLS, right now "WSLS" are just changed to "RA", but we need the correct parameters 
...
for (t in 2:trials) {
  ...
  RA_choices[t] <- RandomAgentNoise_f(RA_choices[t - 1], prev_feedback1) #RA agent choice
